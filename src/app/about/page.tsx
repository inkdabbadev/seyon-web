  ...
  return (
    <div className="bg-ss-black text-white min-h-[100svh] selection:bg-ss-pink selection:text-white overflow-hidden">
      ...
      <section className="pt-32 pb-24 lg:pt-48 lg:pb-32 relative border-b border-white/10">
        <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-ss-orange/5 rounded-full blur-[100px] pointer-events-none translate-x-1/2 -translate-y-1/2"></div>
        
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="font-bold text-white/50 uppercase tracking-[0.3em] text-xs mb-8 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-ss-orange animate-pulse"></span> The Manifesto
          </motion.p>
            ...
            <div className="relative h-[600px] w-full">
               ...
               >
                  <div className="w-full h-full relative overflow-hidden rounded-xl">
                      <Image src="/image/logo/Wild%20Flour%20Mockup.jpg" alt="Wild Flour" fill className="object-cover grayscale hover:grayscale-0 transition-all duration-700" />
                  </div>
               </motion.div>
               <motion.div 
               ...
               >
                  <div className="w-full h-full relative overflow-hidden rounded-xl">
                      <Image src="/image/poster/Poster%20(1).jpeg" alt="Poster" fill className="object-cover grayscale hover:grayscale-0 transition-all duration-700" />
                  </div>
               </motion.div>
            </div>
      ...
      {/* ── Process ── */}
      <section className="py-24 lg:py-40 relative">
        <div className="absolute left-0 top-[20%] w-[30vw] h-[30vw] bg-ss-pink/5 rounded-full blur-[120px] pointer-events-none -translate-x-1/2"></div>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
